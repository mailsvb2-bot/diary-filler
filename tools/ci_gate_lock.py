...
WINDOWS_REQUIRED_IN_ORDER = (
    ...
    "./tools/windows_installer_smoke.ps1 -InstallerPath ./dist/MedicalDiaryAutofill-Setup-1.4.14.exe",
)
...
def main() -> None:
    ...
    for asset in (
        ...
        r"dist\MedicalDiaryAutofill-Setup-1.4.14.exe",
