...
WINDOWS_REQUIRED_IN_ORDER = (
    ...
    "./tools/windows_installer_smoke.ps1 -InstallerPath ./dist/MedicalDiaryAutofill-Setup-1.4.22.exe",
)
...
def main() -> None:
    ...
    for required in (
        "workflow_dispatch:",
        "push:",
        "branches: [production-v1.4.22]",
        "Checkout exact release candidate",
        "Resolve and guard release target",
        "refs/heads/production-v1.4.22",
        "git/ref/heads/main",
    ...
    for asset in (
        ...
        r"dist\MedicalDiaryAutofill-Setup-1.4.22.exe",
