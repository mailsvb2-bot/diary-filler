...
def _make_fixture(root: Path):
    ...
    data.commission_date = "11.06.2026"
    ...
    data.sick_leave_vk_date = "11.06.2026"
    data.sick_leave_vk_protocol_number = "55"
    data.sick_leave_vk_protocol_date = "11.06.2026"
    data.sick_leave_vk_commission_date = "11.06.2026"
