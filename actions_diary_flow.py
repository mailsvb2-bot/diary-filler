...
class ActionsDiaryFlowMixin:
    def _create_diaries_impl(self):
        ...
        if not self.status_files:
            messagebox.showinfo(
                "Нужны тексты дневников",
                "Сейчас выбран шаблон/таблица дневников, но не выбран файл с текстами.\n\n"
                "Выберите любой DOCX из папки с текстами дневников. Если имена файлов соответствуют диагнозам, "
                "программа сама выберет подходящий файл по диагнозу из первичного документа.",
            )
