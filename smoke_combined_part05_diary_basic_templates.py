...
assert "Жалоб не предъявляет." not in contract_joined, contract_joined
...
app4.psych_account_status_var = _Var("нет")
app4.psych_account_since_year_var = _Var("")
app4.rvk_referral_present_var = _Var("нет")
app4.rvk_referral_commissariat_var = _Var("")
