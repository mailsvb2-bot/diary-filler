...
TARGET_VERSION = "1.3.14"
TARGET_VERSION_LABEL = "v1.3.14-ci-contract-fix"
...
def _assert_version_sync() -> None:
    ...
    checks = {
        ...
        "version_info tuple": "filevers=(1, 3, 14, 0)" in version_info and "prodvers=(1, 3, 14, 0)" in version_info,
