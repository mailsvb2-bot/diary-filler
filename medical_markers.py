...
PRIMARY_MARKERS = [
    "Дата, время", "История болезни №", "Ф.И.О.", "Год рождения", "Зарегистрирован", "Регистрация по адресу",
...
COMMISSION_MARKERS = [
    "г.р.,", "Регистрация по адресу", "На учёте у психиатров", "В 3 отделение КДП поступает", "Жалобы при поступлении", "Анамнез жизни",
...
RVK_MARKERS = [
    "О СОСТОЯНИИ", "История болезни №", "Ф.И.О.", "Год рождения", "Проживает", "Регистрация по адресу", "На учёте у психиатров", "Место работы",
