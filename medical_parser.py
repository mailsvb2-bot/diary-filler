...
class MedicalTextParser(
    ...
    FIELD_ALIASES: Dict[str, Sequence[str]] = {
        "case_number": ("История болезни №", "История болезни N", "ИБ №", "Выписной эпикриз №", "Выписной эпикриз N"),
        "fio": ("Ф.И.О. пациента", "ФИО пациента", "Ф.И.О. больного", "ФИО больного", "Фамилия, имя, отчество", "Ф.И.О.", "ФИО", "Фамилия Имя Отчество"),
        "birth": ("Год рождения", "Дата рождения", "г.р.", "Возраст"),
        "registered": ("Зарегистрирован", "зарегистрирован по адресу", "Регистрация по адресу", "Проживает", "Место жительства", "Адрес проживания", "Адрес места жительства", "Адрес регистрации"),
    ...
    BLOCK_ALIASES: Dict[str, Sequence[str]] = {
        ...
        "investigation_results": ("Результаты обследований", "Результаты исследований"),
        "treatment_plan": ("План лечения", "Назначенное лечение", "Получает лечение", "Лечение"),
        "discharge_recommendations": ("Рекомендации при выписке", "Рекомендовано при выписке"),
        "diagnosis": ("Диагноз", "был выставлен диагноз"),
        "epi_text": ("ЭПИ –", "ЭПИ -", "ЭПИ:", "ЭПИ —"),
