...
manual_data.commission_date = "11.06.2026"
...
manual_data.sick_leave_vk_date = "11.06.2026"
manual_data.sick_leave_vk_protocol_number = "55"
manual_data.sick_leave_vk_protocol_date = "11.06.2026"
manual_data.sick_leave_vk_commission_date = "11.06.2026"
...
manual_data.expert_sick_leave_from = "10.06.2026"
...
manual_data.sick_leave = "нужен с 10.06.2026"
...
assert build_expert_anamnesis(manual_data, include_sick_leave_number=False) == "Работает в ООО Завод, в должности инженер. Больничный лист нужен с 10.06.2026."
