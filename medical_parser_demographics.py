...
class MedicalParserDemographicsMixin:
    def _repair_compact_demographics(self, data: PatientData, text: str) -> None:
        ...
        - "Ф.И.О.: Маркер Женская Тестовая, Возраст: 45 лет, Место жительства: Н. Новгород"
        - "Ф.И.О.: Маркер Женская Тестовая, 45 лет, Н. Новгород, ул. ..."
        - "Маркер Женская Тестовая, 45 лет, проживает: Н. Новгород ..."
